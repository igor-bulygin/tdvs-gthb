...
//            'enableStrictParsing' => true,
			...
			'rules' => [
				...
				'/<person_type:(deviser|influencer)>/<slug:[^/.]*?>/<person_id:[^/.]*?>/story/story_id:[^/.]*?>' => 'person/story-detail',
				'/<person_type:(deviser|influencer)>/<slug:[^/.]*?>/<person_id:[^/.]*?>/stories/create' => 'person/story-create',
				'/<person_type:(deviser|influencer)>/<slug:[^/.]*?>/<person_id:[^/.]*?>/story/<product_id:[^/.]*?>/edit' => 'person/story-edit',
