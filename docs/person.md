...
~~~javascript
	...
	type: [], // Each person can have a single or multiple roles, for example, Client and Deviser.
	// Check the constant TYPE_* in Person model for all the valid values for this.
