(function () {
	...
	function controller($scope) {
		...
		$scope.$watch('exploreStoriesResultsCtrl.results', function(newValue, oldValue) {
	...
	var component = {
		templateUrl: currentHost() + '/js/desktop/discover/stories/results/results.html',
		controller: controller,
		controllerAs: 'exploreStoriesResultsCtrl',
		bindings: {
			results: '<'
		}
	}
