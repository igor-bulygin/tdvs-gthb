(function () {
	...
	function influencersCtrl($scope, $timeout, $influencer, $influencer_util, toastr, $uibModal, $compile, $http) {
		var vm = this;
		...
		vm.delete = function (influencer_id) {
			var modalInstance = $uibModal.open({
				...
				resolve: {
					data: function () {
						return {
							title: "Are you sure?",
							text: "You are about to delete a influencer! All items related to this user (products, settings, media....) will be deleted. This action can not be undone"
						};
					}
				}
			});
			...
			modalInstance.result.then(function () {
				$influencer.get({
					...
					$influencer.delete(influencer).then(function (data) {
