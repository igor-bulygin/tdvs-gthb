						...
						?>
							...
							<div class="funiv_bold fs0-857">
								<?= $form->field($model, 'create',['inputOptions' => ['placeholder' => Yii::t('app/public','What do you create?')]])->label(false); ?>
									...
									<div class="form-add-new funiv_bold fs1-071"><span class="fc-f7284b" ng-click="becomeCtrl.newPortFolioLink()"><?=Yii::t('app/public', 'Add new +')?></span></div>
									<div class="form-optional-content funiv fs0-786 fs-upper">
										<div class="form-optional">
											<?=Yii::t('app/public', 'Optional')?>
										</div>
									...
									<div class="form-add-new funiv_bold fs1-071"><span class="fc-f7284b" ng-click="becomeCtrl.newVideoLink()"><?=Yii::t('app/public', 'Add new +')?></span></div>
									<div class="form-optional-content funiv fs0-786 fs-upper">
										<div class="form-optional">
											<?=Yii::t('app/public', 'Optional')?>
										</div>
							...
							<div>
								<span class="fs3-643 funiv_thin fs-upper fc-fff">Email enviado. Revisa tu bandeja de entrada. (prueba)</span>
							</div>
							<?php } ?>
				</div>
			</div>
