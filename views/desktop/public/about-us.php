...
<div class="about-us-wrapper">
	<div class="container">
		<div class="about-slide-1">
			...
			<p class="bold"><?=Yii::t('app/public', 'ABOUT_US_TODEVISE')?></p>
			<p><?=Yii::t('app/public', 'ABOUT_US_TODEVISE_TEXT')?></p>
		</div>
		...
		<div class="about-slide-3">
			<div class="side-text">
				...
				<p class="bold"><?=Yii::t('app/public', 'ABOUT_US_DEVISERS_TEXT_1')?></p>
		...
		<div class="about-slide-4">
			...
			<p class="bold"><?=Yii::t('app/public', 'ABOUT_US_SHOPPING_EXPERIENCE_1')?></p>
			<p><?=Yii::t('app/public', 'ABOUT_US_SHOPPING_EXPERIENCE_2')?></p>
			<p><?=Yii::t('app/public', 'ABOUT_US_SHOPPING_EXPERIENCE_3')?></p>
		</div>
	</div>
</div>
