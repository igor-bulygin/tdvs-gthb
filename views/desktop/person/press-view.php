				...
				<?php if (count($press) == 0) { ?>
					<div class="empty-wrapper">
						<?php if ($person->isPersonEditable()) { ?>
							<div><a href="<?= $person->getPressEditLink()?>" class="red-link-btn"><span translate="person.press.ADD_REMOVE_PHOTOS"></span></a></div>
						<?php } ?>
						<img class="sad-face" src="/imgs/sad-face.svg">
						<p class="no-video-text"><span translate="person.press.NO_PRESS"></span></p>
					</div>
				<?php } else { ?>
					<div class="empty-wrapper">
						<?php if ($person->isPersonEditable()) { ?>
