	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-10" ng-controller="editVideosCtrl as editVideosCtrl">
				...
				<div ng-if="editVideosCtrl.person.videos.length > 0"><a href="#" class="red-link-btn" ng-click="editVideosCtrl.done()">I'm done editing videos</a></div>
					...
					<div class="video-edit-list" ng-cloak dnd-list="editVideosCtrl.person.videos">
						<div class="row video-row" dnd-draggable="video" dnd-effect-allowed="move" dnd-moved="editVideosCtrl.updatePersonVideos($index)" ng-repeat="video in editVideosCtrl.person.videos">
							<div class="col-md-6">
