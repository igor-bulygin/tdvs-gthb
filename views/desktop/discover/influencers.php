	...
	<div class="container">
		...
		<div class="our-devisers-body">
			...
			<div class="col-md-10">
				...
				<div ng-if="" ng-cloak translate="WE_FOUND_X_RESULTS" translate-values="{ counter: discoverCtrl.results.meta.total_count }">"<span class="key" ng-bind="discoverCtrl.search_key"></span>"</p>
				</div>
				<hr />
