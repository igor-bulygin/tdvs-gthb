		...
		<div class="our-devisers-body">
			...
			<div class="col-md-10">
				<div class="found-header">
					<p ng-if="discoverCtrl.search_key && !discoverCtrl.searching" ng-cloak><span translate="discover.WE_FOUND_X_RESULTS" translate-values="{ counter: discoverCtrl.results.meta.total_count, keys: discoverCtrl.search_key }"></span></p>
				</div>
				<!--hr /-->
