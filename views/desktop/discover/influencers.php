...
<div class="our-devisers-wrapper" ng-controller="discoverCtrl as discoverCtrl">
	<div class="container">
		<div class="our-influencers-header">
			<h3 translate="OUR_INFLUENCERS"></h3>
			<h5 class="text-center" translate="DISCOVER_INFLUENCERS"></h5>
			<div class="row">
		...
		<div class="our-devisers-body">
			...
			<div class="col-md-10">
				<div class="found-header">
					<p ng-if="discoverCtrl.search_key" ng-cloak translate="WE_FOUND_X_RESULTS" translate-values="{ counter: discoverCtrl.results.meta.total_count }">"<span class="key" ng-bind="discoverCtrl.search_key"></span>"</p>
				</div>
				<hr />
