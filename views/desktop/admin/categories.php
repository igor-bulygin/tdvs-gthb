		...
		<div class="row no-gutter page-title-row bgcolor-3d">
			<div class="row-same-height">
				...
				<div class="col-xs-4 col-height col-middle text-center">
					...
					<button class="btn btn-purple fc-fff funiv fs0-786 fs-upper" ng-click="create()"><?= Yii::t("app/admin", "Create root category"); ?></button>
				</div>
			</div>
		</div>
...
<script type="text/ng-template" id="template/modal/category/create_new.html">
	<form novalidate name="form" class="popup-tag">
		...
		<div class='modal-body'>
			...
			<div class="input-group">
				<input id="slug" required="" type="text" class="form-control funiv fs1" placeholder="<?= Yii::t("app/admin", "Slug..."); ?>" aria-describedby="basic-addon-slug" ng-model="slug" name="slug">
...
<script type="text/ng-template" id="template/modal/category/edit.html">
	<form novalidate name="form" class="popup-tag">
		...
		<div class='modal-body'>
			...
			<label class="modal-title funiv fs1 fnormal fc-18"><?= Yii::t("app/admin", "Slug"); ?></label>
			<div class="input-group">
				<input id="slug" required="" type="text" class="form-control funiv fs1" placeholder="<?= Yii::t("app/admin", "Slug..."); ?>" aria-describedby="basic-addon-slug" ng-model="data.category.slug" name="slug">
				<span class="input-group-addon alert-danger funiv fs0-929" id="basic-addon-slug" ng-show="form.$submitted && !form.$valid && !form['slug'].$valid">
					<span ng-show="form['slug'].$error.required"><?= Yii::t("app/admin", "Required!"); ?></span>
				</span>
			</div>
