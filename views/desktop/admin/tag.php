	...
	<div class="col-xs-12 no-horizontal-padding">
			...
			<div class="row-same-height">
				...
				<div class="col-xs-8 col-height col-middle">
					<div class="pull-right">
						<button class="btn btn-grey fc-fff funiv fs-upper fs0-786" ng-click="cancel()"><?= Yii::t("app/admin", "Cancel changes"); ?></button>
		...
		<div class="row no-gutter">
			<div class="col-xs-2 div-bordered tag_settings">
				<div class="checkbox">
					<label class="funiv fs0-929 fc-c7">
						<input type="checkbox" ng-model="tag.enabled" ng-checked="tag.enabled"> <?= Yii::t("app/admin", "Enabled"); ?>
					</label>
				</div>
			</div>
			<div class="col-xs-2 div-bordered tag_settings">
			...
			<div class="col-xs-3 div-bordered tag_settings">
				<div class="checkbox">
					<label class="funiv fs0-929 fc-c7">
						<input type="checkbox" ng-model="tag.stock_and_price" ng-checked="tag.stock_and_price"> <?= Yii::t("app/admin", "Use in price and stock chart"); ?>
					</label>
				</div>
			</div>
						...
						<div class="col-xs-6 col-height col-middle">
							<div class="radio flex flex-justify-around">
								<label class="funiv fs0-786 fc-c7 fs-upper">
									<input type="radio" name="tagType" id="tagType1" value="<?= Tag::DROPDOWN; ?>" ng-model="tag.type">
									<label for="tagType1"><span></span><?= Yii::t("app/admin", "With options"); ?></label>
								</label>
								<label class="funiv fs0-786  fc-c7 fs-upper">
									<input type="radio" name="tagType" id="tagType2" value="<?= Tag::FREETEXT; ?>" ng-model="tag.type">
		...
		<div class="ng-cloak" ng-show="tag.type == <?= Tag::DROPDOWN; ?> && pending_dialog_type === false">
			<div class="row no-gutter page-title-row bgcolor-3d">
				<div class="row-same-height">
					<div class="col-xs-4 col-height col-middle">
					...
					<div class="col-xs-2 col-height col-middle">
						<button class="btn btn-purple fc-fff funiv fs0-786 fs-upper" ng-click="edit_dropdown_option(-1)"><?= Yii::t("app/admin", "Create new"); ?></button>
					</div>
				</div>
			</div>
			...
			<div class="row no-gutter">
				<div class="row-same-height row-free-field" ng-repeat="option in tag.options">
					<div class="col-xs-10 col-height col-middle tag">
						<input type="text" class="form-control funiv fc-e8 fs1" placeholder="<?= Yii::t("app/admin", "Field name (optional)"); ?>" ng-model="tag.options[$index].text[lang]">
					</div>
		...
		<div class='modal-body'>
			...
			<div ng-if="opt_value_or_color == 1">
				...
				<span class="input-group-addon alert-danger funiv fs0-929" id="basic-addon-value" ng-show="form.$submitted && !form.$valid && !form['value'].$valid">
					...
					<span ng-show="!form['value'].$error.required && form['value'].$invalid"><?= Yii::t("app/admin", "Invalid value!"); ?></span>
				</span>
				</div>
			</div>
