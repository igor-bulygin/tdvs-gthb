		...
		<div ng-if="!bannerCtrl.loading" ng-cloak>
			<div class="row" >
				<div class="col-md-10 col-md-offset-1">
					<form class="row" name="bannerCtrl.newBannerForm" novalidate ng-if="bannerCtrl.viewNewBanner"  ng-cloak>
						...
						<div class="col-md-10">
							...
							<div class="col-md-10" ng-if="bannerCtrl.newBanner.image[bannerCtrl.name_language]" ng-cloak>
								<img class="grid-image" ng-src="{{bannerCtrl.newImage[bannerCtrl.name_language].url}}">
							</div>
						</div>
					...
					<div class="panel faq-panel" ng-if="bannerCtrl.banners.length > 0 && !bannerCtrl.viewNewBanner" ng-cloak>
						<uib-accordion>
							<div uib-accordion-group ng-repeat="banner in bannerCtrl.banners">
								<uib-accordion-heading class="panel-heading panel-heading-faq" >
									<h4 class="panel-title">
										<span class="col-md-10" ng-bind="banner.alt_text[bannerCtrl.lang]"></span>
									</h4>
