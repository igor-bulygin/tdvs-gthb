...
?>
	...
	<div class="row no-gutter" ng-controller="faqsCtrl as faqsCtrl">
				...
				<div class="row-same-height">
					...
					<div class="col-xs-5 col-height col-middle">
						<div class="input-group">
							...
							<input type="text" class="form-control" placeholder="<?= Yii::t("app/admin", "Category name... "); ?>" aria-describedby="basic-addon1" ng-model="faqsCtrl.searchModel" ng-change="faqsCtrl.search()">
						</div>
					</div>

					<div class="col-xs-4 col-height col-middle text-center">
						<button class="btn btn-light-green fc-fff funiv fs0-786 fs-upper margin-l0-r1" ng-click="faqsCtrl.open_all()">
							<?= Yii::t("app/admin", "Open all"); ?>
						</button>
						<button class="btn btn-coral fc-fff funiv fs0-786 fs-upper margin-l0-r1" ng-click="faqsCtrl.close_all()">
							<?= Yii::t("app/admin", "Close all"); ?>
						</button>
						<button class="btn btn-purple fc-fff funiv fs0-786 fs-upper" ng-click="faqsCtrl.create()">
							<?= Yii::t("app/admin", "Create new category"); ?>
						</button>
					</div>
				</div>
			</div>

			<div js-tree="faqsCtrl.treeConfig" ng-model="faqsCtrl.treeData" tree="faqsCtrl.treeInstance" tree-events="ready:faqsCtrl.readyCB;create_node:faqsCtrl.restoreState;move_node:faqsCtrl.move">
			</div>
