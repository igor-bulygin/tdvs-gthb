				...
				<div class="product-data-wrapper">
					...
					<div class="product-data">
						<div class="row-size">
							<form class="form-horizontal">
								<div class="form-group">
									<label class="col-sm-3 control-label product-label"><span class="atr">Size</span> <i
											class="ion-information-circled info"></i></label>
									<div class="col-sm-9">
										<div class="size-box" data-toggle="tooltip" data-placement="top"
										     title="+ €5,50">
						...
						<div class="row-size">
							<form class="form-horizontal">
								<div class="form-group">
									<label class="col-sm-3 control-label product-label"><span
											class="atr">Color</span></label>
									<div class="col-sm-9">
										<div class="color-box" data-toggle="tooltip" data-placement="top"
										     title="+ €5,50">
											<input type="radio" name="colors" id="radio-1">
											<label for="radio-1">
												<span class="radio red"></span> </label>
										</div>
										<div class="color-box">
											<input type="radio" name="colors" id="radio-2">
											<label for="radio-2">
												<span class="radio blue"></span> </label>
										</div>
										<div class="color-box">
											<input type="radio" name="colors" id="radio-3">
											<label for="radio-3">
												<span class="radio green"></span> </label>
										</div>
										<div class="color-box" data-toggle="tooltip" data-placement="top"
										     title="+ €5,50">
											<input type="radio" name="colors" id="radio-4">
											<label for="radio-4">
												<span class="radio red"></span> </label>
										</div>
										<div class="color-box">
											<input type="radio" name="colors" id="radio-5">
											<label for="radio-5">
												<span class="radio blue"></span> </label>
										</div>
										<div class="color-box">
											<input type="radio" name="colors" id="radio-6">
											<label for="radio-6">
												<span class="radio green"></span> </label>
										</div>
									</div>
						...
						<div class="row-size">
							<form class="form-horizontal">
								<div class="form-group">
									<label class="col-sm-3 control-label product-label"><span
											class="atr">Material</span></label>
									<div class="col-sm-9">
										<select class="form-control selectpicker product-select"
						...
						<div class="row-size">
							<form class="form-horizontal">
								<div class="form-group">
									<label class="col-sm-3 control-label product-label"><span
											class="atr">Diameter</span></label>
									<div class="col-sm-9">
										<select class="form-control selectpicker product-select"
										        title="Choose diameter">
											<option></option>
						...
						<div class="row-size">
							<button type="button" class="btn btn-green btn-add-to-cart"><i
									class="ion-ios-cart cart-icon-btn"></i> <span>Add to cart</span></button>
						</div>
					</div>
					<div class="product-data">
						<div class="row-size">
							<div class="shipping-policies-wrapper">
								...
								<div class="policies-row">
									<form class="form-horizontal">
										<div class="form-group">
											<label
												class="col-sm-4 control-label shipping-label"><span>Shipping price to</span></label>
											<div class="col-sm-5 shipping-sel"><select
													class="form-control selectpicker shipping-select product-select"
			...
			<div role="tabpanel" class="tab-pane active work-description-wrapper" id="description">
				...
				<div class="reviews-wrapper">
					...
					<div class="comment-wrapper">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control comment-input" id="exampleInputEmail1"
					...
					<div class="comment-user response">
						...
						<div class="comment">
							...
							<div class="comment-text">Vivamus ultricies mauris mi, nec imperdiet quam facilisis eget
								ultricies mauris mi, nec imperdiet quam facilisis eget ultricies mauris mi, nec
								imperdiet quam facilisis eget ultricies mauris mi, nec imperdiet quam facilisis eget
								ultricies mauris mi, nec imperdiet quam facilisis eget ultricies mauris mi, nec
								imperdiet quam facilisis eget.
							</div>
						</div>
						<div class="helpful">
							<span>Is this review helpful to you ?</span>
