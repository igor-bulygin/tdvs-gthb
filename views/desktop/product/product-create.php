	...
	<div class="create-work-wrapper" >
		...
		<div class="container" >
			<div ng-show="!createProductCtrl.saving">
				<product-basic-info ng-if="createProductCtrl.allCategories" product="createProductCtrl.product" categories="createProductCtrl.allCategories" languages="createProductCtrl.languages"></product-basic-info>
