	...
	<div class="create-work-wrapper" >
		...
		<div class="container" >
			<div ng-if="!createProductCtrl.saving" ng-cloak>
				<product-basic-info ng-if="createProductCtrl.emptyCategory" ng-cloak emptyCategory="createProductCtrl.emptyCategory" product="createProductCtrl.product" categories="createProductCtrl.allCategories" languages="createProductCtrl.languages"></product-basic-info>
