	...
	<div ng-if="!authenticationRequiredCtrl.loading" ng-cloak>
		<div class="col-md-6">
			<form name="authenticationRequiredCtrl.loginForm">
				<span class="login-title">Already a user? Sign in</span>
				<div class="create-deviser-account-container black-form">
					...
					<div class="alert alert-danger" ng-if="authenticationRequiredCtrl.errors" ng-cloak>Your email or password are not valid</div>
					<div class="row">
		...
		<div class="col-md-6">
			<form name="authenticationRequiredCtrl.signForm">
				<span class="login-title">New to todevise? Sign up</span>
				<div class="create-deviser-account-container black-form">
					<div class="row">
