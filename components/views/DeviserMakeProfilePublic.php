...
<div class="top-bar-red ng-class:{'top-bar-violet': makeProfilePublicCtrl.errorsRequired}" ng-controller="makeProfilePublicCtrl as makeProfilePublicCtrl">
	<span ng-if="!makeProfilePublicCtrl.errorsRequired">Your profile is not yet public. First, you need to fill in the fields below.</span>
	<span ng-if="makeProfilePublicCtrl.errorsRequired">Please complete all the required fields before making your profile public.</span>
