	...
	<figure class="showcase influencers">
		...
		<figcaption>
			<div class="row">
				...
				<div class="col-md-6">
					<button  class="btn btn-follow full-size-btn btn-icon" ng-click="personComponentCtrl.follow('<?=$person->short_id?>')" ng-cloak ng-if="!personComponentCtrl.isFollowed"><i class="ion-ios-star"></i><span><span translate="discover.FOLLOW"></span></span></button>
					<button class="btn btn-follow full-size-btn btn-red" ng-click="personComponentCtrl.unFollow('<?=$person->short_id?>')" ng-cloak ng-if="personComponentCtrl.isFollowed"><i class="ion-ios-star red-text hidden"></i><span><span translate="discover.UNFOLLOW"></span></span></button>
				</div>
			</div>
		</figcaption>
	</figure>
