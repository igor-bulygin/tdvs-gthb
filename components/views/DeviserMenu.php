...
<nav class="menu-store" data-spy="affix" data-offset-top="450">
	<ul class="mt-0">
		<li>
			<a class="<?= ($activeOption=='store') ? 'active' : '' ?>" href="<?= Url::to(["deviser/store", "slug" => $deviser->slug, 'deviser_id' => $deviser->short_id])?>">Store</a>
	...
	<ul>
		...
		<li>
			<a class="<?= ($activeOption=='press') ? 'active' : '' ?>" href="<?= Url::to(["deviser/press", "slug" => $deviser->slug, 'deviser_id' => $deviser->short_id])?>">Press</a>
		</li>
		<li>
			<a class="<?= ($activeOption=='videos') ? 'active' : '' ?>" href="<?= Url::to(["deviser/videos", "slug" => $deviser->slug, 'deviser_id' => $deviser->short_id])?>">Videos</a>
		</li>
		<li>
			<a class="<?= ($activeOption=='faq') ? 'active' : '' ?>" href="<?= Url::to(["deviser/faq", "slug" => $deviser->slug, 'deviser_id' => $deviser->short_id])?>">FAQ</a>
		</li>
	</ul>
</nav>
