...
<header>
	<div class="row" id="main_header">
		<div class="col-xs-4 col-md-1_5">LOGO</div>
		<div class="col-xs-8 col-md-9">SEARCH FORM</div>
		<div class="hidden-xs col-md-1_5">LOGIN FORM</div>
	</div>
	<nav id="main_nav">
	</nav>
</header>
...
<!--img src="/imgs/logo.png" id="header_logo"-->
		...
		<form class="col-xs-8 navbar-form navbar-left navbar-searcher mobile" action="<?=Url::to(["/works"])?>" method="get">
		...
		<div class="container" id="main_menu">
			<div class="navbar-elements">
				<ul class="nav navbar-nav">
					...
					<li class="col-xs-6 hidden-xg hidden-md">
						<span id="mobIcons_center"></span>
						<img src="/imgs/box-red.svg" href="#" />
						<img src="/imgs/discover-red.svg" href="#" />
						<img src="/imgs/login-red.svg" href="#" />
						<img src="/imgs/cart-red.svg" href="#" />
					</li>
				</ul>
